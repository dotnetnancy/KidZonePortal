...
namespace TestSprocGenerator.Business.SingleTable.Bo.List
{
    ...
    public class Person_PhoneNumber : List<TestSprocGenerator.Data.SingleTable.Dto.Person_PhoneNumber>
    {
        ...
        private CommonLibrary.Base.Business.BaseBusiness<TestSprocGenerator.Business.SingleTable.Bo.Person_PhoneNumber, TestSprocGenerator.Data.SingleTable.Dto.Person_PhoneNumber> _baseBusiness;
        
        private CommonLibrary.Base.Database.BaseDataAccess<TestSprocGenerator.Data.SingleTable.Dto.Person_PhoneNumber> _baseDataAccess;
        
        public Person_PhoneNumber()
        {
        }
        
        public Person_PhoneNumber(CommonLibrary.DatabaseSmoObjectsAndSettings databaseSmoObjectsAndSettings)
        {
        ...
        private void FillByGetPermutation(CommonLibrary.Enumerations.GetPermutations getPermutation, TestSprocGenerator.Business.SingleTable.Bo.Person_PhoneNumber filledBo)
        {
            if (this.BaseDataAccessAvailable())
            {
                this.Clear();
                TestSprocGenerator.Data.SingleTable.Dto.Person_PhoneNumber dto = ((TestSprocGenerator.Data.SingleTable.Dto.Person_PhoneNumber)(filledBo));
                List<TestSprocGenerator.Data.SingleTable.Dto.Person_PhoneNumber> returnDto = _baseDataAccess.Get(dto, getPermutation);
                ...
                if ((control > 0))
                {
                    ...
                    {
                        TestSprocGenerator.Business.SingleTable.Bo.Person_PhoneNumber boToFill = new TestSprocGenerator.Business.SingleTable.Bo.Person_PhoneNumber(_databaseSmoObjectsAndSettings);
        ...
        public virtual void FillByPrimaryKey(TestSprocGenerator.Business.SingleTable.Bo.Person_PhoneNumber filledBo)
        {
        ...
        public virtual void FillByCriteriaFuzzy(TestSprocGenerator.Business.SingleTable.Bo.Person_PhoneNumber filledBo)
        {
            CommonLibrary.Enumerations.GetPermutations getPermutation = CommonLibrary.Enumerations.GetPermutations.ByFuzzyCriteria;
            this.FillByGetPermutation(getPermutation, filledBo);
        }
        
        public virtual void FillByCriteriaExact(TestSprocGenerator.Business.SingleTable.Bo.Person_PhoneNumber filledBo)
        {
            CommonLibrary.Enumerations.GetPermutations getPermutation = CommonLibrary.Enumerations.GetPermutations.ByExplicitCriteria;
            this.FillByGetPermutation(getPermutation, filledBo);
        }
        
        public virtual void FillByGetAll(TestSprocGenerator.Business.SingleTable.Bo.Person_PhoneNumber filledBo)
        {
