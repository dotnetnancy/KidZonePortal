...
namespace TestSprocGenerator.Business.SingleTable.Bo.List
{
    ...
    public class CustomerDemographics : List<TestSprocGenerator.Data.SingleTable.Dto.CustomerDemographics>
    {
        ...
        private CommonLibrary.Base.Business.BaseBusiness<TestSprocGenerator.Business.SingleTable.Bo.CustomerDemographics, TestSprocGenerator.Data.SingleTable.Dto.CustomerDemographics> _baseBusiness;
        
        private CommonLibrary.Base.Database.BaseDataAccess<TestSprocGenerator.Data.SingleTable.Dto.CustomerDemographics> _baseDataAccess;
        
        public CustomerDemographics()
        {
        }
        
        public CustomerDemographics(CommonLibrary.DatabaseSmoObjectsAndSettings databaseSmoObjectsAndSettings)
        {
        ...
        private void FillByGetPermutation(CommonLibrary.Enumerations.GetPermutations getPermutation, TestSprocGenerator.Business.SingleTable.Bo.CustomerDemographics filledBo)
        {
            if (this.BaseDataAccessAvailable())
            {
                this.Clear();
                TestSprocGenerator.Data.SingleTable.Dto.CustomerDemographics dto = ((TestSprocGenerator.Data.SingleTable.Dto.CustomerDemographics)(filledBo));
                List<TestSprocGenerator.Data.SingleTable.Dto.CustomerDemographics> returnDto = _baseDataAccess.Get(dto, getPermutation);
                ...
                if ((control > 0))
                {
                    ...
                    {
                        TestSprocGenerator.Business.SingleTable.Bo.CustomerDemographics boToFill = new TestSprocGenerator.Business.SingleTable.Bo.CustomerDemographics();
        ...
        public virtual void FillByPrimaryKey(TestSprocGenerator.Business.SingleTable.Bo.CustomerDemographics filledBo)
        {
        ...
        public virtual void FillByCriteriaFuzzy(TestSprocGenerator.Business.SingleTable.Bo.CustomerDemographics filledBo)
        {
            CommonLibrary.Enumerations.GetPermutations getPermutation = CommonLibrary.Enumerations.GetPermutations.ByFuzzyCriteria;
            this.FillByGetPermutation(getPermutation, filledBo);
        }
        
        public virtual void FillByCriteriaExact(TestSprocGenerator.Business.SingleTable.Bo.CustomerDemographics filledBo)
        {
            CommonLibrary.Enumerations.GetPermutations getPermutation = CommonLibrary.Enumerations.GetPermutations.ByExplicitCriteria;
            this.FillByGetPermutation(getPermutation, filledBo);
        }
        
        public virtual void FillByGetAll(TestSprocGenerator.Business.SingleTable.Bo.CustomerDemographics filledBo)
        {
