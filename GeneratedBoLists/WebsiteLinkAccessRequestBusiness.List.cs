...
namespace TestSprocGenerator.Business.SingleTable.Bo.List
{
    ...
    public class WebsiteLinkAccessRequest : List<TestSprocGenerator.Data.SingleTable.Dto.WebsiteLinkAccessRequest>
    {
        ...
        private CommonLibrary.Base.Business.BaseBusiness<TestSprocGenerator.Business.SingleTable.Bo.WebsiteLinkAccessRequest, TestSprocGenerator.Data.SingleTable.Dto.WebsiteLinkAccessRequest> _baseBusiness;
        
        private CommonLibrary.Base.Database.BaseDataAccess<TestSprocGenerator.Data.SingleTable.Dto.WebsiteLinkAccessRequest> _baseDataAccess;
        
        public WebsiteLinkAccessRequest()
        {
        }
        
        public WebsiteLinkAccessRequest(CommonLibrary.DatabaseSmoObjectsAndSettings databaseSmoObjectsAndSettings)
        {
        ...
        private void FillByGetPermutation(CommonLibrary.Enumerations.GetPermutations getPermutation, TestSprocGenerator.Business.SingleTable.Bo.WebsiteLinkAccessRequest filledBo)
        {
            if (this.BaseDataAccessAvailable())
            {
                this.Clear();
                TestSprocGenerator.Data.SingleTable.Dto.WebsiteLinkAccessRequest dto = ((TestSprocGenerator.Data.SingleTable.Dto.WebsiteLinkAccessRequest)(filledBo));
                List<TestSprocGenerator.Data.SingleTable.Dto.WebsiteLinkAccessRequest> returnDto = _baseDataAccess.Get(dto, getPermutation);
                ...
                if ((control > 0))
                {
                    ...
                    {
                        TestSprocGenerator.Business.SingleTable.Bo.WebsiteLinkAccessRequest boToFill = new TestSprocGenerator.Business.SingleTable.Bo.WebsiteLinkAccessRequest(_databaseSmoObjectsAndSettings);
        ...
        public virtual void FillByPrimaryKey(TestSprocGenerator.Business.SingleTable.Bo.WebsiteLinkAccessRequest filledBo)
        {
        ...
        public virtual void FillByCriteriaFuzzy(TestSprocGenerator.Business.SingleTable.Bo.WebsiteLinkAccessRequest filledBo)
        {
            CommonLibrary.Enumerations.GetPermutations getPermutation = CommonLibrary.Enumerations.GetPermutations.ByFuzzyCriteria;
            this.FillByGetPermutation(getPermutation, filledBo);
        }
        
        public virtual void FillByCriteriaExact(TestSprocGenerator.Business.SingleTable.Bo.WebsiteLinkAccessRequest filledBo)
        {
            CommonLibrary.Enumerations.GetPermutations getPermutation = CommonLibrary.Enumerations.GetPermutations.ByExplicitCriteria;
            this.FillByGetPermutation(getPermutation, filledBo);
        }
        
        public virtual void FillByGetAll(TestSprocGenerator.Business.SingleTable.Bo.WebsiteLinkAccessRequest filledBo)
        {
