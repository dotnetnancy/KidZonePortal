...
namespace TestSprocGenerator.Business.SingleTable.Bo.List
{
    ...
    public class CustomerCustomerDemo : List<TestSprocGenerator.Data.SingleTable.Dto.CustomerCustomerDemo>
    {
        ...
        private CommonLibrary.Base.Business.BaseBusiness<TestSprocGenerator.Business.SingleTable.Bo.CustomerCustomerDemo, TestSprocGenerator.Data.SingleTable.Dto.CustomerCustomerDemo> _baseBusiness;
        
        private CommonLibrary.Base.Database.BaseDataAccess<TestSprocGenerator.Data.SingleTable.Dto.CustomerCustomerDemo> _baseDataAccess;
        ...
        private void FillByGetPermutation(CommonLibrary.Enumerations.GetPermutations getPermutation, TestSprocGenerator.Business.SingleTable.Bo.CustomerCustomerDemo filledBo)
        {
            if (this.BaseDataAccessAvailable())
            {
                this.Clear();
                TestSprocGenerator.Data.SingleTable.Dto.CustomerCustomerDemo dto = ((TestSprocGenerator.Data.SingleTable.Dto.CustomerCustomerDemo)(filledBo));
                List<TestSprocGenerator.Data.SingleTable.Dto.CustomerCustomerDemo> returnDto = _baseDataAccess.Get(dto, getPermutation);
                ...
                if ((control > 0))
                {
                    ...
                    {
                        TestSprocGenerator.Business.SingleTable.Bo.CustomerCustomerDemo boToFill = new TestSprocGenerator.Business.SingleTable.Bo.CustomerCustomerDemo();
        ...
        public virtual void FillByPrimaryKey(TestSprocGenerator.Business.SingleTable.Bo.CustomerCustomerDemo filledBo)
        {
        ...
        public virtual void FillByCriteriaFuzzy(TestSprocGenerator.Business.SingleTable.Bo.CustomerCustomerDemo filledBo)
        {
            CommonLibrary.Enumerations.GetPermutations getPermutation = CommonLibrary.Enumerations.GetPermutations.ByFuzzyCriteria;
            this.FillByGetPermutation(getPermutation, filledBo);
        }
        
        public virtual void FillByCriteriaExact(TestSprocGenerator.Business.SingleTable.Bo.CustomerCustomerDemo filledBo)
        {
            CommonLibrary.Enumerations.GetPermutations getPermutation = CommonLibrary.Enumerations.GetPermutations.ByExplicitCriteria;
            this.FillByGetPermutation(getPermutation, filledBo);
        }
        
        public virtual void FillByGetAll(TestSprocGenerator.Business.SingleTable.Bo.CustomerCustomerDemo filledBo)
        {
