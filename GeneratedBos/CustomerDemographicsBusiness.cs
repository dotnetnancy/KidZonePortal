...
namespace TestSprocGenerator.Business.SingleTable.Bo
{
    ...
    public class CustomerDemographics : TestSprocGenerator.Data.SingleTable.Dto.CustomerDemographics
    {
        ...
        private void FillPropertiesFromBo(TestSprocGenerator.Business.SingleTable.Bo.CustomerDemographics filledBo)
        {
            _baseBusiness.FillPropertiesFromBo(filledBo, this);
        }
        
        private void FillThisWithDto(TestSprocGenerator.Data.SingleTable.Dto.CustomerDemographics filledDto)
        {
        ...
        public virtual void Insert()
        {
            ...
            {
                TestSprocGenerator.Data.SingleTable.Dto.CustomerDemographics dto = _baseBusiness.FillDtoWithThis(this);
                TestSprocGenerator.Data.SingleTable.Dto.CustomerDemographics returnDto = _baseDataAccess.Insert(dto);
        ...
        public virtual void Update()
        {
            ...
            {
                TestSprocGenerator.Data.SingleTable.Dto.CustomerDemographics dto = _baseBusiness.FillDtoWithThis(this);
                TestSprocGenerator.Data.SingleTable.Dto.CustomerDemographics returnDto = _baseDataAccess.Update(dto);
                this.FillThisWithDto(returnDto);
            }
            else
            {
        ...
        public virtual void Delete()
        {
            ...
            {
                TestSprocGenerator.Data.SingleTable.Dto.CustomerDemographics dto = _baseBusiness.FillDtoWithThis(this);
                TestSprocGenerator.Data.SingleTable.Dto.CustomerDemographics returnDto = _baseDataAccess.Delete(dto);
                this.FillThisWithDto(returnDto);
            }
            else
            {
        ...
        public virtual void GetByPrimaryKey()
        {
            if (this.BaseDataAccessAvailable())
            {
                TestSprocGenerator.Data.SingleTable.Dto.CustomerDemographics dto = this;
                List<TestSprocGenerator.Data.SingleTable.Dto.CustomerDemographics> returnDto = _baseDataAccess.Get(dto, CommonLibrary.Enumerations.GetPermutations.ByPrimaryKey);
