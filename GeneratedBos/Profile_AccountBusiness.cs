...
namespace TestSprocGenerator.Business.SingleTable.Bo
{
    ...
    public class Profile_Account : TestSprocGenerator.Data.SingleTable.Dto.Profile_Account
    {
        ...
        public Profile_Account(CommonLibrary.DatabaseSmoObjectsAndSettings databaseSmoObjectsAndSettings, TestSprocGenerator.Business.SingleTable.Bo.Profile_Account filledBo)
        {
            _databaseSmoObjectsAndSettings = databaseSmoObjectsAndSettings;
            _baseDataAccess = 
                new CommonLibrary.Base.Database.BaseDataAccess<TestSprocGenerator.Data.SingleTable.Dto.Profile_Account>(_databaseSmoObjectsAndSettings);
        ...
        private void FillPropertiesFromBo(TestSprocGenerator.Business.SingleTable.Bo.Profile_Account filledBo)
        {
        ...
        public virtual void Insert()
        {
            if (this.BaseDataAccessAvailable())
            {
                ...
                TestSprocGenerator.Data.SingleTable.Dto.Profile_Account returnDto = _baseDataAccess.Insert(dto);
        ...
        public virtual void Update()
        {
            ...
            {
                TestSprocGenerator.Data.SingleTable.Dto.Profile_Account dto = _baseBusiness.FillDtoWithThis(this);
                TestSprocGenerator.Data.SingleTable.Dto.Profile_Account returnDto = _baseDataAccess.Update(dto);
                this.FillThisWithDto(returnDto);
            }
            else
            {
