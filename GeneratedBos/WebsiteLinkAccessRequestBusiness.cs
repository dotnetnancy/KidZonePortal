...
namespace TestSprocGenerator.Business.SingleTable.Bo
{
    ...
    public class WebsiteLinkAccessRequest : TestSprocGenerator.Data.SingleTable.Dto.WebsiteLinkAccessRequest
    {
        ...
        private void FillPropertiesFromBo(TestSprocGenerator.Business.SingleTable.Bo.WebsiteLinkAccessRequest filledBo)
        {
            _baseBusiness.FillPropertiesFromBo(filledBo, this);
        }
        
        private void FillThisWithDto(TestSprocGenerator.Data.SingleTable.Dto.WebsiteLinkAccessRequest filledDto)
        {
        ...
        public virtual void Insert()
        {
            ...
            {
                TestSprocGenerator.Data.SingleTable.Dto.WebsiteLinkAccessRequest dto = _baseBusiness.FillDtoWithThis(this);
                TestSprocGenerator.Data.SingleTable.Dto.WebsiteLinkAccessRequest returnDto = _baseDataAccess.Insert(dto);
        ...
        public virtual void Update()
        {
            ...
            {
                TestSprocGenerator.Data.SingleTable.Dto.WebsiteLinkAccessRequest dto = _baseBusiness.FillDtoWithThis(this);
                TestSprocGenerator.Data.SingleTable.Dto.WebsiteLinkAccessRequest returnDto = _baseDataAccess.Update(dto);
                this.FillThisWithDto(returnDto);
            }
            else
            {
        ...
        public virtual void Delete()
        {
            ...
            {
                TestSprocGenerator.Data.SingleTable.Dto.WebsiteLinkAccessRequest dto = _baseBusiness.FillDtoWithThis(this);
                TestSprocGenerator.Data.SingleTable.Dto.WebsiteLinkAccessRequest returnDto = _baseDataAccess.Delete(dto);
                this.FillThisWithDto(returnDto);
            }
            else
            {
        ...
        public virtual void GetByPrimaryKey()
        {
            if (this.BaseDataAccessAvailable())
            {
                TestSprocGenerator.Data.SingleTable.Dto.WebsiteLinkAccessRequest dto = this;
                List<TestSprocGenerator.Data.SingleTable.Dto.WebsiteLinkAccessRequest> returnDto = _baseDataAccess.Get(dto, CommonLibrary.Enumerations.GetPermutations.ByPrimaryKey);
