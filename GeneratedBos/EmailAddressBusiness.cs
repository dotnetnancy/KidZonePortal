...
namespace TestSprocGenerator.Business.SingleTable.Bo
{
    ...
    public class EmailAddress : TestSprocGenerator.Data.SingleTable.Dto.EmailAddress
    {
        ...
        public EmailAddress(CommonLibrary.DatabaseSmoObjectsAndSettings databaseSmoObjectsAndSettings, TestSprocGenerator.Business.SingleTable.Bo.EmailAddress filledBo)
        {
            _databaseSmoObjectsAndSettings = databaseSmoObjectsAndSettings;
            _baseDataAccess = 
                new CommonLibrary.Base.Database.BaseDataAccess<TestSprocGenerator.Data.SingleTable.Dto.EmailAddress>(_databaseSmoObjectsAndSettings);
        ...
        private void FillPropertiesFromBo(TestSprocGenerator.Business.SingleTable.Bo.EmailAddress filledBo)
        {
        ...
        public virtual void Insert()
        {
            if (this.BaseDataAccessAvailable())
            {
                ...
                TestSprocGenerator.Data.SingleTable.Dto.EmailAddress returnDto = _baseDataAccess.Insert(dto);
        ...
        public virtual void Update()
        {
            ...
            {
                TestSprocGenerator.Data.SingleTable.Dto.EmailAddress dto = _baseBusiness.FillDtoWithThis(this);
                TestSprocGenerator.Data.SingleTable.Dto.EmailAddress returnDto = _baseDataAccess.Update(dto);
                this.FillThisWithDto(returnDto);
            }
            else
            {
