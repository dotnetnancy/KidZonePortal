...
namespace TestSprocGenerator.Business.SingleTable.Bo
{
    ...
    public class PhoneNumberType : TestSprocGenerator.Data.SingleTable.Dto.PhoneNumberType
    {
        ...
        public PhoneNumberType(CommonLibrary.DatabaseSmoObjectsAndSettings databaseSmoObjectsAndSettings, TestSprocGenerator.Business.SingleTable.Bo.PhoneNumberType filledBo)
        {
            _databaseSmoObjectsAndSettings = databaseSmoObjectsAndSettings;
            _baseDataAccess = 
                new CommonLibrary.Base.Database.BaseDataAccess<TestSprocGenerator.Data.SingleTable.Dto.PhoneNumberType>(_databaseSmoObjectsAndSettings);
        ...
        private void FillPropertiesFromBo(TestSprocGenerator.Business.SingleTable.Bo.PhoneNumberType filledBo)
        {
            _baseBusiness.FillPropertiesFromBo(filledBo, this);
        }
        
        private void FillThisWithDto(TestSprocGenerator.Data.SingleTable.Dto.PhoneNumberType filledDto)
        {
        ...
        public virtual void Insert()
        {
            ...
            {
                TestSprocGenerator.Data.SingleTable.Dto.PhoneNumberType dto = _baseBusiness.FillDtoWithThis(this);
                TestSprocGenerator.Data.SingleTable.Dto.PhoneNumberType returnDto = _baseDataAccess.Insert(dto);
        ...
        public virtual void Update()
        {
            ...
            {
                TestSprocGenerator.Data.SingleTable.Dto.PhoneNumberType dto = _baseBusiness.FillDtoWithThis(this);
                TestSprocGenerator.Data.SingleTable.Dto.PhoneNumberType returnDto = _baseDataAccess.Update(dto);
                this.FillThisWithDto(returnDto);
            }
            else
            {
        ...
        public virtual void Delete()
        {
            ...
            {
                TestSprocGenerator.Data.SingleTable.Dto.PhoneNumberType dto = _baseBusiness.FillDtoWithThis(this);
                TestSprocGenerator.Data.SingleTable.Dto.PhoneNumberType returnDto = _baseDataAccess.Delete(dto);
                this.FillThisWithDto(returnDto);
            }
            else
            {
        ...
        public virtual void GetByPrimaryKey()
        {
            if (this.BaseDataAccessAvailable())
            {
                TestSprocGenerator.Data.SingleTable.Dto.PhoneNumberType dto = this;
                List<TestSprocGenerator.Data.SingleTable.Dto.PhoneNumberType> returnDto = _baseDataAccess.Get(dto, CommonLibrary.Enumerations.GetPermutations.ByPrimaryKey);
