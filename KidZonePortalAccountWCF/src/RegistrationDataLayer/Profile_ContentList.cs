...
namespace TestSprocGenerator.SingleTable.List
{
    ...
    public class Profile_Content : List<TestSprocGenerator.Data.SingleTable.Dto.Profile_Content>
    {
        ...
        public Profile_Content(System.Data.SqlClient.SqlDataReader reader)
        {
        ...
        public virtual void AddItemsToListBySqlDataReader(System.Data.SqlClient.SqlDataReader reader)
        {
            ...
            TestSprocGenerator.Data.SingleTable.Dto.Profile_Content dto;
                using(reader)
                {

                while(reader.Read())
                {
            dto = new TestSprocGenerator.Data.SingleTable.Dto.Profile_Content();
                    dto.Profile_ContentID = 
                    _baseDatabase.retrieveGuidFromDataReader(reader.GetOrdinal("Profile_ContentID"), reader);
                    dto.Deleted = 
