...
namespace TestSprocGenerator.SingleTable.List
{
    ...
    public class EmailAddress : List<TestSprocGenerator.Data.SingleTable.Dto.EmailAddress>
    {
        ...
        public EmailAddress(System.Data.SqlClient.SqlDataReader reader)
        {
        ...
        public virtual void AddItemsToListBySqlDataReader(System.Data.SqlClient.SqlDataReader reader)
        {
            ...
            TestSprocGenerator.Data.SingleTable.Dto.EmailAddress dto;
                using(reader)
                {

                while(reader.Read())
                {
            dto = new TestSprocGenerator.Data.SingleTable.Dto.EmailAddress();
                    dto.Deleted = 
                    ...
                    dto.EmailAddress_Property = _baseDatabase.resolveNullString(reader.GetOrdinal("EmailAddress"),reader);
                    this.Add(dto);
                }
