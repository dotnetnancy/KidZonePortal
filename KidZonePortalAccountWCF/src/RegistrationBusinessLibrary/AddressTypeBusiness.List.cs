...
namespace TestSprocGenerator.Business.SingleTable.Bo.List
{
    ...
    public class AddressType : List<TestSprocGenerator.Data.SingleTable.Dto.AddressType>
    {
        ...
        private CommonLibrary.Base.Business.BaseBusiness<TestSprocGenerator.Business.SingleTable.Bo.AddressType, TestSprocGenerator.Data.SingleTable.Dto.AddressType> _baseBusiness;
        
        private CommonLibrary.Base.Database.BaseDataAccess<TestSprocGenerator.Data.SingleTable.Dto.AddressType> _baseDataAccess;
        
        public AddressType()
        {
        }
        
        public AddressType(CommonLibrary.DatabaseSmoObjectsAndSettings databaseSmoObjectsAndSettings)
        {
        ...
        private void FillByGetPermutation(CommonLibrary.Enumerations.GetPermutations getPermutation, TestSprocGenerator.Business.SingleTable.Bo.AddressType filledBo)
        {
            if (this.BaseDataAccessAvailable())
            {
                this.Clear();
                TestSprocGenerator.Data.SingleTable.Dto.AddressType dto = ((TestSprocGenerator.Data.SingleTable.Dto.AddressType)(filledBo));
                List<TestSprocGenerator.Data.SingleTable.Dto.AddressType> returnDto = _baseDataAccess.Get(dto, getPermutation);
                ...
                if ((control > 0))
                {
                    ...
                    {
                        TestSprocGenerator.Business.SingleTable.Bo.AddressType boToFill = new TestSprocGenerator.Business.SingleTable.Bo.AddressType(_databaseSmoObjectsAndSettings);
        ...
        public virtual void FillByPrimaryKey(TestSprocGenerator.Business.SingleTable.Bo.AddressType filledBo)
        {
        ...
        public virtual void FillByCriteriaFuzzy(TestSprocGenerator.Business.SingleTable.Bo.AddressType filledBo)
        {
            CommonLibrary.Enumerations.GetPermutations getPermutation = CommonLibrary.Enumerations.GetPermutations.ByFuzzyCriteria;
            this.FillByGetPermutation(getPermutation, filledBo);
        }
        
        public virtual void FillByCriteriaExact(TestSprocGenerator.Business.SingleTable.Bo.AddressType filledBo)
        {
            CommonLibrary.Enumerations.GetPermutations getPermutation = CommonLibrary.Enumerations.GetPermutations.ByExplicitCriteria;
            this.FillByGetPermutation(getPermutation, filledBo);
        }
        
        public virtual void FillByGetAll(TestSprocGenerator.Business.SingleTable.Bo.AddressType filledBo)
        {
