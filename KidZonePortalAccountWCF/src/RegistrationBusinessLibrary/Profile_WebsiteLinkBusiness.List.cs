...
namespace TestSprocGenerator.Business.SingleTable.Bo.List
{
    ...
    public class Profile_WebsiteLink : List<TestSprocGenerator.Data.SingleTable.Dto.Profile_WebsiteLink>
    {
        ...
        private CommonLibrary.Base.Business.BaseBusiness<TestSprocGenerator.Business.SingleTable.Bo.Profile_WebsiteLink, TestSprocGenerator.Data.SingleTable.Dto.Profile_WebsiteLink> _baseBusiness;
        
        private CommonLibrary.Base.Database.BaseDataAccess<TestSprocGenerator.Data.SingleTable.Dto.Profile_WebsiteLink> _baseDataAccess;
        
        public Profile_WebsiteLink()
        {
        }
        
        public Profile_WebsiteLink(CommonLibrary.DatabaseSmoObjectsAndSettings databaseSmoObjectsAndSettings)
        {
        ...
        private void FillByGetPermutation(CommonLibrary.Enumerations.GetPermutations getPermutation, TestSprocGenerator.Business.SingleTable.Bo.Profile_WebsiteLink filledBo)
        {
            if (this.BaseDataAccessAvailable())
            {
                this.Clear();
                TestSprocGenerator.Data.SingleTable.Dto.Profile_WebsiteLink dto = ((TestSprocGenerator.Data.SingleTable.Dto.Profile_WebsiteLink)(filledBo));
                List<TestSprocGenerator.Data.SingleTable.Dto.Profile_WebsiteLink> returnDto = _baseDataAccess.Get(dto, getPermutation);
                ...
                if ((control > 0))
                {
                    ...
                    {
                        TestSprocGenerator.Business.SingleTable.Bo.Profile_WebsiteLink boToFill = new TestSprocGenerator.Business.SingleTable.Bo.Profile_WebsiteLink(_databaseSmoObjectsAndSettings);
        ...
        public virtual void FillByPrimaryKey(TestSprocGenerator.Business.SingleTable.Bo.Profile_WebsiteLink filledBo)
        {
        ...
        public virtual void FillByCriteriaFuzzy(TestSprocGenerator.Business.SingleTable.Bo.Profile_WebsiteLink filledBo)
        {
            CommonLibrary.Enumerations.GetPermutations getPermutation = CommonLibrary.Enumerations.GetPermutations.ByFuzzyCriteria;
            this.FillByGetPermutation(getPermutation, filledBo);
        }
        
        public virtual void FillByCriteriaExact(TestSprocGenerator.Business.SingleTable.Bo.Profile_WebsiteLink filledBo)
        {
            CommonLibrary.Enumerations.GetPermutations getPermutation = CommonLibrary.Enumerations.GetPermutations.ByExplicitCriteria;
            this.FillByGetPermutation(getPermutation, filledBo);
        }
        
        public virtual void FillByGetAll(TestSprocGenerator.Business.SingleTable.Bo.Profile_WebsiteLink filledBo)
        {
