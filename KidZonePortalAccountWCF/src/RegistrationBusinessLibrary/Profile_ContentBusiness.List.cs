...
namespace TestSprocGenerator.Business.SingleTable.Bo.List
{
    ...
    public class Profile_Content : List<TestSprocGenerator.Data.SingleTable.Dto.Profile_Content>
    {
        ...
        private void FillByGetPermutation(CommonLibrary.Enumerations.GetPermutations getPermutation, TestSprocGenerator.Business.SingleTable.Bo.Profile_Content filledBo)
        {
            if (this.BaseDataAccessAvailable())
            {
                this.Clear();
                TestSprocGenerator.Data.SingleTable.Dto.Profile_Content dto = ((TestSprocGenerator.Data.SingleTable.Dto.Profile_Content)(filledBo));
                List<TestSprocGenerator.Data.SingleTable.Dto.Profile_Content> returnDto = _baseDataAccess.Get(dto, getPermutation);
                ...
                if ((control > 0))
                {
                    ...
                    {
                        TestSprocGenerator.Business.SingleTable.Bo.Profile_Content boToFill = new TestSprocGenerator.Business.SingleTable.Bo.Profile_Content(_databaseSmoObjectsAndSettings);
        ...
        public virtual void FillByPrimaryKey(TestSprocGenerator.Business.SingleTable.Bo.Profile_Content filledBo)
        {
        ...
        public virtual void FillByCriteriaFuzzy(TestSprocGenerator.Business.SingleTable.Bo.Profile_Content filledBo)
        {
            CommonLibrary.Enumerations.GetPermutations getPermutation = CommonLibrary.Enumerations.GetPermutations.ByFuzzyCriteria;
            this.FillByGetPermutation(getPermutation, filledBo);
        }
        
        public virtual void FillByCriteriaExact(TestSprocGenerator.Business.SingleTable.Bo.Profile_Content filledBo)
        {
            CommonLibrary.Enumerations.GetPermutations getPermutation = CommonLibrary.Enumerations.GetPermutations.ByExplicitCriteria;
            this.FillByGetPermutation(getPermutation, filledBo);
        }
        
        public virtual void FillByGetAll(TestSprocGenerator.Business.SingleTable.Bo.Profile_Content filledBo)
        {
