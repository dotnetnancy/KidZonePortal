...
namespace TestSprocGenerator.Business.SingleTable.Bo
{
    ...
    public class Profile_Blog : TestSprocGenerator.Data.SingleTable.Dto.Profile_Blog
    {
        ...
        public Profile_Blog(CommonLibrary.DatabaseSmoObjectsAndSettings databaseSmoObjectsAndSettings, TestSprocGenerator.Business.SingleTable.Bo.Profile_Blog filledBo)
        {
            _databaseSmoObjectsAndSettings = databaseSmoObjectsAndSettings;
            _baseDataAccess = 
                new CommonLibrary.Base.Database.BaseDataAccess<TestSprocGenerator.Data.SingleTable.Dto.Profile_Blog>(_databaseSmoObjectsAndSettings);
        ...
        private void FillPropertiesFromBo(TestSprocGenerator.Business.SingleTable.Bo.Profile_Blog filledBo)
        {
            _baseBusiness.FillPropertiesFromBo(filledBo, this);
        }
        
        private void FillThisWithDto(TestSprocGenerator.Data.SingleTable.Dto.Profile_Blog filledDto)
        {
        ...
        public virtual void Insert()
        {
            ...
            {
                TestSprocGenerator.Data.SingleTable.Dto.Profile_Blog dto = _baseBusiness.FillDtoWithThis(this);
                TestSprocGenerator.Data.SingleTable.Dto.Profile_Blog returnDto = _baseDataAccess.Insert(dto);
        ...
        public virtual void Update()
        {
            ...
            {
                TestSprocGenerator.Data.SingleTable.Dto.Profile_Blog dto = _baseBusiness.FillDtoWithThis(this);
                TestSprocGenerator.Data.SingleTable.Dto.Profile_Blog returnDto = _baseDataAccess.Update(dto);
                this.FillThisWithDto(returnDto);
            }
            else
            {
        ...
        public virtual void Delete()
        {
            ...
            {
                TestSprocGenerator.Data.SingleTable.Dto.Profile_Blog dto = _baseBusiness.FillDtoWithThis(this);
                TestSprocGenerator.Data.SingleTable.Dto.Profile_Blog returnDto = _baseDataAccess.Delete(dto);
                this.FillThisWithDto(returnDto);
            }
            else
            {
        ...
        public virtual void GetByPrimaryKey()
        {
            if (this.BaseDataAccessAvailable())
            {
                TestSprocGenerator.Data.SingleTable.Dto.Profile_Blog dto = this;
                List<TestSprocGenerator.Data.SingleTable.Dto.Profile_Blog> returnDto = _baseDataAccess.Get(dto, CommonLibrary.Enumerations.GetPermutations.ByPrimaryKey);
