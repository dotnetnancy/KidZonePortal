...
namespace TestSprocGenerator.Business.SingleTable.Bo
{
    ...
    public class Person_PhoneNumber : TestSprocGenerator.Data.SingleTable.Dto.Person_PhoneNumber
    {
        ...
        private void FillPropertiesFromBo(TestSprocGenerator.Business.SingleTable.Bo.Person_PhoneNumber filledBo)
        {
            _baseBusiness.FillPropertiesFromBo(filledBo, this);
        }
        
        private void FillThisWithDto(TestSprocGenerator.Data.SingleTable.Dto.Person_PhoneNumber filledDto)
        {
        ...
        public virtual void Insert()
        {
            ...
            {
                TestSprocGenerator.Data.SingleTable.Dto.Person_PhoneNumber dto = _baseBusiness.FillDtoWithThis(this);
                TestSprocGenerator.Data.SingleTable.Dto.Person_PhoneNumber returnDto = _baseDataAccess.Insert(dto);
        ...
        public virtual void Update()
        {
            ...
            {
                TestSprocGenerator.Data.SingleTable.Dto.Person_PhoneNumber dto = _baseBusiness.FillDtoWithThis(this);
                TestSprocGenerator.Data.SingleTable.Dto.Person_PhoneNumber returnDto = _baseDataAccess.Update(dto);
                this.FillThisWithDto(returnDto);
            }
            else
            {
        ...
        public virtual void Delete()
        {
            ...
            {
                TestSprocGenerator.Data.SingleTable.Dto.Person_PhoneNumber dto = _baseBusiness.FillDtoWithThis(this);
                TestSprocGenerator.Data.SingleTable.Dto.Person_PhoneNumber returnDto = _baseDataAccess.Delete(dto);
                this.FillThisWithDto(returnDto);
            }
            else
            {
        ...
        public virtual void GetByPrimaryKey()
        {
            if (this.BaseDataAccessAvailable())
            {
                TestSprocGenerator.Data.SingleTable.Dto.Person_PhoneNumber dto = this;
                List<TestSprocGenerator.Data.SingleTable.Dto.Person_PhoneNumber> returnDto = _baseDataAccess.Get(dto, CommonLibrary.Enumerations.GetPermutations.ByPrimaryKey);
