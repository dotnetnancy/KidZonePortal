...
namespace TestSprocGenerator.Business.SingleTable.Bo.List
{
    ...
    public class PhoneNumberType : List<TestSprocGenerator.Data.SingleTable.Dto.PhoneNumberType>
    {
        ...
        private CommonLibrary.Base.Business.BaseBusiness<TestSprocGenerator.Business.SingleTable.Bo.PhoneNumberType, TestSprocGenerator.Data.SingleTable.Dto.PhoneNumberType> _baseBusiness;
        
        private CommonLibrary.Base.Database.BaseDataAccess<TestSprocGenerator.Data.SingleTable.Dto.PhoneNumberType> _baseDataAccess;
        ...
        private void FillByGetPermutation(CommonLibrary.Enumerations.GetPermutations getPermutation, TestSprocGenerator.Business.SingleTable.Bo.PhoneNumberType filledBo)
        {
            if (this.BaseDataAccessAvailable())
            {
                this.Clear();
                TestSprocGenerator.Data.SingleTable.Dto.PhoneNumberType dto = ((TestSprocGenerator.Data.SingleTable.Dto.PhoneNumberType)(filledBo));
                List<TestSprocGenerator.Data.SingleTable.Dto.PhoneNumberType> returnDto = _baseDataAccess.Get(dto, getPermutation);
                ...
                if ((control > 0))
                {
                    ...
                    {
                        TestSprocGenerator.Business.SingleTable.Bo.PhoneNumberType boToFill = new TestSprocGenerator.Business.SingleTable.Bo.PhoneNumberType(_databaseSmoObjectsAndSettings);
        ...
        public virtual void FillByPrimaryKey(TestSprocGenerator.Business.SingleTable.Bo.PhoneNumberType filledBo)
        {
        ...
        public virtual void FillByCriteriaFuzzy(TestSprocGenerator.Business.SingleTable.Bo.PhoneNumberType filledBo)
        {
            CommonLibrary.Enumerations.GetPermutations getPermutation = CommonLibrary.Enumerations.GetPermutations.ByFuzzyCriteria;
            this.FillByGetPermutation(getPermutation, filledBo);
        }
        
        public virtual void FillByCriteriaExact(TestSprocGenerator.Business.SingleTable.Bo.PhoneNumberType filledBo)
        {
            CommonLibrary.Enumerations.GetPermutations getPermutation = CommonLibrary.Enumerations.GetPermutations.ByExplicitCriteria;
            this.FillByGetPermutation(getPermutation, filledBo);
        }
        
        public virtual void FillByGetAll(TestSprocGenerator.Business.SingleTable.Bo.PhoneNumberType filledBo)
        {
