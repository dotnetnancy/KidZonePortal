...
namespace CountryCityProvinceDataLayer
{
    public class CityCountryProvinceStateDataAccess
    {
        ...
        static CityCountryProvinceStateDataAccess()
        {
            _log = _log = log4net.LogManager.GetLogger(Assembly.GetExecutingAssembly().GetType());
        }

        public CityCountryProvinceStateDataAccess()
        {
