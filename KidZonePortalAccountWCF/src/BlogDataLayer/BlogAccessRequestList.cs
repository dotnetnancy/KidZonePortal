...
namespace TestSprocGenerator.SingleTable.List
{
    ...
    public class BlogAccessRequest : List<TestSprocGenerator.Data.SingleTable.Dto.BlogAccessRequest>
    {
        ...
        public BlogAccessRequest(System.Data.SqlClient.SqlDataReader reader)
        {
        ...
        public virtual void AddItemsToListBySqlDataReader(System.Data.SqlClient.SqlDataReader reader)
        {
            ...
            TestSprocGenerator.Data.SingleTable.Dto.BlogAccessRequest dto;
                using(reader)
                {

                while(reader.Read())
                {
            dto = new TestSprocGenerator.Data.SingleTable.Dto.BlogAccessRequest();
                    dto.BlogAccessRequestID = 
                    _baseDatabase.retrieveGuidFromDataReader(reader.GetOrdinal("BlogAccessRequestID"), reader);
                    dto.BlogID = 
