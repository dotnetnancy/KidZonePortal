...
namespace TestSprocGenerator.Business.SingleTable.Bo
{
    ...
    public class PasswordResetRequest : TestSprocGenerator.Data.SingleTable.Dto.PasswordResetRequest
    {
        ...
        private void FillPropertiesFromBo(TestSprocGenerator.Business.SingleTable.Bo.PasswordResetRequest filledBo)
        {
            _baseBusiness.FillPropertiesFromBo(filledBo, this);
        }
        
        private void FillThisWithDto(TestSprocGenerator.Data.SingleTable.Dto.PasswordResetRequest filledDto)
        {
        ...
        public virtual void Insert()
        {
            ...
            {
                TestSprocGenerator.Data.SingleTable.Dto.PasswordResetRequest dto = _baseBusiness.FillDtoWithThis(this);
                TestSprocGenerator.Data.SingleTable.Dto.PasswordResetRequest returnDto = _baseDataAccess.Insert(dto);
        ...
        public virtual void Update()
        {
            ...
            {
                TestSprocGenerator.Data.SingleTable.Dto.PasswordResetRequest dto = _baseBusiness.FillDtoWithThis(this);
                TestSprocGenerator.Data.SingleTable.Dto.PasswordResetRequest returnDto = _baseDataAccess.Update(dto);
                this.FillThisWithDto(returnDto);
            }
            else
            {
        ...
        public virtual void Delete()
        {
            ...
            {
                TestSprocGenerator.Data.SingleTable.Dto.PasswordResetRequest dto = _baseBusiness.FillDtoWithThis(this);
                TestSprocGenerator.Data.SingleTable.Dto.PasswordResetRequest returnDto = _baseDataAccess.Delete(dto);
                this.FillThisWithDto(returnDto);
            }
            else
            {
        ...
        public virtual void GetByPrimaryKey()
        {
            if (this.BaseDataAccessAvailable())
            {
                TestSprocGenerator.Data.SingleTable.Dto.PasswordResetRequest dto = this;
                List<TestSprocGenerator.Data.SingleTable.Dto.PasswordResetRequest> returnDto = _baseDataAccess.Get(dto, CommonLibrary.Enumerations.GetPermutations.ByPrimaryKey);
