...
namespace TestSprocGenerator.SingleTable.List
{
    ...
    public class Profile : List<TestSprocGenerator.Data.SingleTable.Dto.Profile>
    {
        ...
        public Profile(System.Data.SqlClient.SqlDataReader reader)
        {
        ...
        public virtual void AddItemsToListBySqlDataReader(System.Data.SqlClient.SqlDataReader reader)
        {
            ...
            TestSprocGenerator.Data.SingleTable.Dto.Profile dto;
                using(reader)
                {

                while(reader.Read())
                {
            dto = new TestSprocGenerator.Data.SingleTable.Dto.Profile();
                    dto.ProfileTypeID = 
