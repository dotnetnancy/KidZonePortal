...
namespace TestSprocGenerator.SingleTable.List
{
    ...
    public class Profile_Blog : List<TestSprocGenerator.Data.SingleTable.Dto.Profile_Blog>
    {
        ...
        public Profile_Blog(System.Data.SqlClient.SqlDataReader reader)
        {
        ...
        public virtual void AddItemsToListBySqlDataReader(System.Data.SqlClient.SqlDataReader reader)
        {
            ...
            TestSprocGenerator.Data.SingleTable.Dto.Profile_Blog dto;
                using(reader)
                {

                while(reader.Read())
                {
            dto = new TestSprocGenerator.Data.SingleTable.Dto.Profile_Blog();
                    dto.Profile_BlogID = 
                    _baseDatabase.retrieveGuidFromDataReader(reader.GetOrdinal("Profile_BlogID"), reader);
                    dto.Deleted = 
